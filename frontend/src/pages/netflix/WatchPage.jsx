...
import { ORIGINAL_IMG_BASE_URL, SMALL_IMG_BASE_URL } from "../../utils/netflix/constants";
...
const NetflixWatchPage = () => {
	...
	useEffect(() => {
		const getSimilarContent = async () => {
			try {
				const res = await axios.get(`/api/v1/netflix/${contentType}/${id}/similar`);
				...
				<div className='aspect-video mb-8 p-2 sm:px-10 md:px-32'>
					{trailers.length > 0 && (
						<ReactPlayer
							...
							url={`https://www.youtube.com/netflix/watch?v=${trailers[currentTrailerIdx].key}`}
						/>
					)}
					...
					<div className='mt-12 max-w-5xl mx-auto relative'>
						...
						<div className='flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group' ref={sliderRef}>
							{similarContent.map((content) => {
								...
								return (
									<Link key={content.id} to={`/netflix/watch/${content.id}`} className='w-52 flex-none'>
										<img
...
export default NetflixWatchPage;
